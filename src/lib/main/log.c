...
void fep_log(FEP *fep, int level, const char *format, ...)
{
    ...
    snprintf(logmsg, sizeof(logmsg), "%02d/%02d %02d:%02d:%02d [%s - %s]", korean_tm.tm_mon + 1, korean_tm.tm_mday, korean_tm.tm_hour, korean_tm.tm_min, korean_tm.tm_sec, fep->procname, GET_CALLER_FUNCTION());
